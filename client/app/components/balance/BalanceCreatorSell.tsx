...
import BalanceBuyerDetails from './BalanceBuyerDetails';
  ...
  componentDidMount() {
    ...
    .then(userdata => {  
      if (userdata) {
        ...
        this.handleUpdateBalance({seller:currentUser});
          ...
          <div className="new-balance-container">
            <section className="new-balance-box">
              ...
              <div className="new-balance-action-container">
                <BalanceStepCard
                  text={`${seller.username} as seller`} 
                  subtext={`The buyer sets the initial terms of the balance.
                ...
                <BalanceStepCard
                  text={buyer.email || 'Select your buyer'}
                  subtext={
                    seller.num_completed_balances
                      ? `${buyer.num_completed_balances} successful contracts`
