    ...
    return (
      <div className="default-container">
        ...
        <div className="component-container">
          ...
          <div>
            <label className="label-default">label-default</label>
            <input
              type="text"
          ...
          <div>
            <label className="label-default -large">label-default -large</label>
            <input
              type="text"
        ...
        <div className="component-container">
          ...
          <h3 style={{ color: '#d0d0d0' }}>@border-gray: #d0d0d0;</h3>
          <h3 style={{ color: '#eee' }}>@light-gray: #eee;</h3>
          <h3 style={{ color: '#2b2b2b' }}>@black: #2b2b2b;</h3>
          <h3 style={{ color: '#3e886b' }}>@dark-green: #3e886b</h3>
          <h3 style={{ color: '#3db787' }}>@bright-green: #3db787;</h3>
          <h3 style={{ color: '#da2a54' }}>@red: #da2a54;</h3>
          <h3
            style={{
              background: '#d0d0d0',
              color: '#fff',
